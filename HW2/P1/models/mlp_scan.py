...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.conv1d_stride1.W = w1[:48,:2].reshape(self.conv1.conv1d_stride1.W.T.shape).T
        self.conv2.conv1d_stride1.W = w2[:4,:8].reshape(self.conv2.conv1d_stride1.W.T.shape).T
